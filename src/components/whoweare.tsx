      ...
      <div className="service-items">
        <a href="#">
          <div className="service-item">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" className="bi bi-globe" viewBox="0 0 16 16">
        ...
        <a href="#">
          <div className="service-item">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" className="bi bi-gpu-card" viewBox="0 0 16 16">
        ...
        <a href="#">
          <div className="service-item">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" className="bi bi-server" viewBox="0 0 16 16">
